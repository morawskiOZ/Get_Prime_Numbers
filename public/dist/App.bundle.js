...
function pickTheNumbers(search) {
	...
	var firstNumber = search.querySelector("#firstNumber");
	var secondNumber = search.querySelector("#secondNumber");
	...
	searchButton.on("click", function () {
		...
		axios.get("/api/prime?firstNumber=" + firstNumber.value + "&secondNumber=" + secondNumber.value).then(function (res) {
			if (res.data) {
				var html = res.data.join(", ");
...
exports.default = pickTheNumbers;
...
var _pickTheNumbers = __webpack_require__(8);

var _pickTheNumbers2 = _interopRequireDefault(_pickTheNumbers);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _pickTheNumbers2.default)((0, _bling.$)(".search"));
